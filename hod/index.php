...
<div class="row">
 ...
 $query = "SELECT * FROM bani WHERE leave_type = 'mid-term' ";
    ...
    ?>                          
     ...
     $element_text = ['Total Leaves','Emergency leaves','Casual','Academic','Mid-Term','Departments'];
     
    $element_count = [$leaves_counts, $leaves_emergency_count, $leaves_casual_count, $leaves_academic_count, $leaves_mid_term_count, $dept_counts]; 
