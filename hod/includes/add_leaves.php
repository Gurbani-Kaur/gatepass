...
$image_temp = $_FILES['image']['tmp_name'];
  ...
  move_uploaded_file($image_temp,"../images/$image");
    ...
    $query = "INSERT INTO bani(stud_name,stud_id, class, father_name, reason, date_from, date_to, leave_type, address, image)" ;
    
$query .= "VALUES('{$stud_name}','{$stud_id}','{$class}','{$father_name}','{$reason}','{$date_from}','{$date_to}','{$leave_type}','{$address}','{$image}')";
    
    
 $create_leave_query = mysqli_query($connection, $query);
    
 confirm($create_leave_query);
