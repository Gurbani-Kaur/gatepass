...
$image_temp = $_FILES['image']['tmp_name'];
  ...
  move_uploaded_file($image_temp,"../images/$image");
    ...
    $query = "INSERT INTO bani(stud_id, stud_name, class, father_name, reason, date_from, date_to, leave_type, address, image)" ;
    
$query .= "VALUES('{$stud_id}','{$stud_name}','{$class}','{$father_name}','{$reason}','{$date_from}','{$date_to}','{$leave_type}','{$address}','{$image}')";
