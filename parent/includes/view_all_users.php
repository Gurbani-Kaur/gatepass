  ...
  // $query = "SELECT * FROM posts WHERE post_id = $comment_post_id ";
   ...
   //     $post_id = $row['post_id'];
     ...
     //   }
        ...
        echo "<td><a href='users.php?change_to_parent={$user_id}'>Parent</a></td>";
...
if(isset($_GET['change_to_parent'])){
    
    $the_user_id =($_GET['change_to_parent']);
    
    $query = "UPDATE users SET user_role = 'parent' WHERE user_id = $the_user_id ";
    $approve_comment_query = mysqli_query($connection, $query);
    header("Location: users.php");
